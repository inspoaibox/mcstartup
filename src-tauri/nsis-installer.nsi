; Custom NSIS template derived from the current Tauri-generated installer.
; Purpose: keep the uninstall "Delete app data" option unchecked by default.
Unicode true
...
!searchreplace RESOURCESSRCPATH "${MAINBINARYSRCPATH}" "${MAINBINARYNAME}.exe" "resources"
